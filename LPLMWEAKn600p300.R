...
cat("The programs starts at", date(), "\n")
...
fileConn = "VariableSelectionResultsLPLMweakp300n600.txt"
...
write(x=paste("MMSE of BAR-AIC is :", MMSE.BARAIC, sep = ""),fileConn, append = TRUE)
write(x=paste("MMSE of Lasso is :", MMSE.Lasso, sep = ""),fileConn, append = TRUE)
write(x=paste("MMSE of ALasso is :", MMSE.ALasso, sep = ""),fileConn, append = TRUE)
write(x=paste("MMSE of BAR-BIC is :", MMSE.BARBIC, sep = ""),fileConn, append = TRUE)
write(x=paste("MMSE of Oracle is:", MMSE.GLMMLE, sep = ""),fileConn, append = TRUE)
write(x=paste("SD of BAR-AIC is :", SD.BARAIC, sep = ""),fileConn, append = TRUE)
write(x=paste("SD of Lasso is :", SD.Lasso, sep = ""),fileConn, append = TRUE)
write(x=paste("SD of ALasso is :", SD.ALasso, sep = ""),fileConn, append = TRUE)
write(x=paste("SD of SCAD is :", SD.BARBIC, sep = ""),fileConn, append = TRUE)
write(x=paste("SD of Oracle is:", SD.GLMMLE, sep = ""),fileConn, append = TRUE)

fileConn2 = "EstimationResultsLPLMweakp300n600.txt"
